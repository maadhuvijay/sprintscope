 ...
 * Note: This is typically handled by the LLM directly, but kept for consistency
...
export async function generate_sql(
  ...
  // This function is typically not called directly - the LLM generates SQL
  // But we keep it for potential future use or explicit SQL generation requests
  throw new Error('generate_sql should be handled by LLM. Use LLM tool calling instead.');
}
 ...
 * Note: This is typically handled by the LLM, but kept for consistency
...
export async function explain_results(
  ...
  // This function is typically not called directly - the LLM explains results
  // But we keep it for potential future use
  throw new Error('explain_results should be handled by LLM. Use LLM tool calling instead.');
}
